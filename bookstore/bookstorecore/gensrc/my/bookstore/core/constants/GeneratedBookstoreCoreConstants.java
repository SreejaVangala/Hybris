...
public class GeneratedBookstoreCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String CUSTOMWCMSCOMPONENT = "CustomWcmsComponent".intern();
		public static final String ELECTRONICSCOLORVARIANTPRODUCT = "ElectronicsColorVariantProduct".intern();
		public static final String FIRSTCRONJOB = "FirstCronJob".intern();
	...
	public static class Attributes
	{
		...
		{
			public static final String RATING = "rating".intern();
